...
1.Design and implementation of a bidirectional DC-DC converter architecture for EV applications

2.Support for both buck and boost operating modes to enable flexible power flow control

3.Integration of V2G and V2V capabilities for bidirectional energy exchange

4.Development and simulation of the complete converter model using MATLAB/Simulink

5.Performance validation focused on efficiency, voltage regulation, and system stability
